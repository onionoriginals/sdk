...
import { selectFundingUtxos, inscriptionContentBytes } from '../sdk/funding';
...
// Funding selection lives in ../sdk/funding so the inscription dry run can
// drive the shipped selection; re-exported here for the existing import sites.
export { selectFundingUtxos, inscriptionContentBytes } from '../sdk/funding';
export type { FundingUtxo, FundingSelection } from '../sdk/funding';
