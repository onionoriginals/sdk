/**
 * Explicit, passphrase-based encrypted backup for a locally-held Ed25519
 * authoring key (#598) — a portable export the visitor themselves triggers
 * and remembers the passphrase for, independent of this browser's storage.
 *
