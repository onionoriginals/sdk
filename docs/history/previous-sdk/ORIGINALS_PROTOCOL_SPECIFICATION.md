> Historical pre-3.0 draft, retained for reference. It is not the current
> normative contract; see the [CEL 3 wire and proof profile](../../../specs/originals-cel-v3-profile.md),
> [controller authority and publication fold](../../../specs/originals-cel-v3-authority.md),
> and [Bitcoin inscription shape](../../../specs/btco-inscription-shape.md) instead.
