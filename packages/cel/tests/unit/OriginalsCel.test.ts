...
import { OriginalsCel, type CelSigner, type OriginalsCelConfig } from '../../src/OriginalsCel';
import type { DataIntegrityProof, EventLog, ExternalReference } from '../../src/types';
