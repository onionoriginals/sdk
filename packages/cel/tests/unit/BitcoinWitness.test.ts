...
describe('BitcoinWitness', () => {
  ...
  let mockBitcoinManager: CelBitcoinManager;
  ...
  describe('constructor', () => {
    ...
    it('throws error for null BitcoinManager', () => {
      expect(() => new BitcoinWitness(null as unknown as CelBitcoinManager))
        .toThrow('BitcoinManager instance is required');
    });

    it('throws error for undefined BitcoinManager', () => {
      expect(() => new BitcoinWitness(undefined as unknown as CelBitcoinManager))
        .toThrow('BitcoinManager instance is required');
    });
