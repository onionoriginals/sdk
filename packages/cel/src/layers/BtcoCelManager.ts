...
import type { CelBitcoinManager } from '../types.js';
...
export class BtcoCelManager {
  ...
  private bitcoinManager?: CelBitcoinManager;
  ...
  constructor(
    signer: CelSigner,
    bitcoinManager?: CelBitcoinManager,
  ...
  private requireBitcoinManager(): CelBitcoinManager {
   ...
   */
  get bitcoin(): CelBitcoinManager | undefined {
    return this.bitcoinManager;
  }
}
