...
export const users = pgTable("users", {
  ...
  authWalletId: text("auth_wallet_id"), // Turnkey wallet ID for authentication
  assertionWalletId: text("assertion_wallet_id"), // Turnkey wallet ID for assertions (ED25519)
  updateWalletId: text("update_wallet_id"), // Turnkey wallet ID for DID updates (ED25519)
