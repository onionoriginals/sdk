...
// Note: Commit transaction types are now defined in src/bitcoin/transactions/commit.ts
// to match legacy ordinalsplus structure. Import from there for commit transaction operations.
